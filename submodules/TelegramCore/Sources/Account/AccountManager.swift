...
private var declaredEncodables: Void = {
    ...
    declareEncodable(StuxnetMessageHistoryAttribute.self, f: { StuxnetMessageHistoryAttribute(decoder: $0) })
    declareEncodable(StuxnetDeletedMessageAttribute.self, f: { StuxnetDeletedMessageAttribute(decoder: $0) })
